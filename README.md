...
![GitHub closed pull requests](https://img.shields.io/github/issues-pr-closed/UNN-IASR/mod-lab05-life)

Срок выполнения задания:

**по 03.05.2026** ![Relative date](https://img.shields.io/date/1777842000)

## Lab 05. Исследование клеточных автоматов на примере игры "Жизнь"
...
- Классифицировать элементы, сопоставляя с образцами (взять 5-6 самых распространенных стабильных фигур)
...
- График сохранять в виде PNG-изображения в **plot.png** в папке **Data** проекта
- Исходные числовые данные для графика сохранять в файле **Data/data.txt**
